...
It is designed for local review. The three examples are fictional and use bundled data only:
...
The copyable English submission draft is in [docs/submission-draft.md](docs/submission-draft.md). Validation notes are in [docs/validation.md](docs/validation.md).
